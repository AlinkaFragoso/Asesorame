...
$(document).ready(function(){
    var pieData = [
        {data: 1, color: '#F44336', label: 'Árbol caído'},
        {data: 2, color: '#03A9F4', label: 'Bache'},
        {data: 3, color: '#8BC34A', label: 'Obstrucción'},
        {data: 4, color: '#FFEB3B', label: 'Inundación'},
        {data: 4, color: '#009688', label: 'Otros'},
    ];

    var pieData2 = [
        {data: 1, color: '#F44336', label: 'Abierto'},
        {data: 2, color: '#03A9F4', label: 'Resuelto'},
        {data: 3, color: '#8BC34A', label: 'Cancelado'},
    ];

    

    var pieData4 = [
        {data: 1, color: '#F44336', label: 'Desconocido'},
        {data: 2, color: '#03A9F4', label: 'Administrador'},
        {data: 3, color: '#8BC34A', label: 'Fernando Fuentes'},
        {data: 4, color: '#FFEB3B', label: 'Diego Filloy'},
    ];
